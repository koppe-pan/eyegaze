defmodule Eyegaze.Rooms do
  alias Eyegaze.{Room, Tracker}
  ...
  def create(name, opts \\ []) do
    ...
    case DynamicSupervisor.start_child(Eyegaze.RoomSupervisor, {Room, opts}) do
      {:ok, pid} ->
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(Eyegaze.PubSub, @topic)
  end
end
