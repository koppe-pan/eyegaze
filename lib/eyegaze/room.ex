defmodule Eyegaze.Room do
  use GenServer, restart: :temporary

  alias Eyegaze.User
  alias Eyegaze.Room.State
  ...
  def subscribe(room_id) do
    Phoenix.PubSub.subscribe(Eyegaze.PubSub, @topic_prefix <> room_id)
  end
  ...
  defp broadcast_message(room_id, message) do
    Phoenix.PubSub.broadcast(Eyegaze.PubSub, @topic_prefix <> room_id, message)
  end
end
